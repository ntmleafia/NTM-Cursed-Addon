...
public class AddonItemBaked extends AddonItemBase implements IDynamicModels {
	String texturePath;

	public AddonItemBaked(String s, String texturePath) {
		super(s);
		this.texturePath = texturePath;
		INSTANCES.add(this);
	}

	public AddonItemBaked(String s) {
		super(s);
		this.texturePath = s;
		INSTANCES.add(this);
	}
