...
public class ComputerCableBlock extends AddonBlockBaked implements ITileEntityProvider, IRadResistantBlock {
	final boolean radSealed;
	public ComputerCableBlock(Material m,String s,boolean radSealed,String tex) {
		super(m,s,tex);
