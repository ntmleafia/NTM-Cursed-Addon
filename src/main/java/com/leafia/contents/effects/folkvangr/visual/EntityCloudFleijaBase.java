...
public class EntityCloudFleijaBase extends Entity {

	public static final DataParameter<Integer> MAXAGE = EntityDataManager.createKey(EntityCloudFleijaBase.class,DataSerializers.VARINT);
	public static final DataParameter<Float> SCALE = EntityDataManager.createKey(EntityCloudFleijaBase.class,DataSerializers.FLOAT);
	public static final DataParameter<Float> TICKRATE = EntityDataManager.createKey(EntityCloudFleijaBase.class,DataSerializers.FLOAT);
	public static final DataParameter<Boolean> ANTISCHRAB = EntityDataManager.createKey(EntityCloudFleijaBase.class,DataSerializers.BOOLEAN);
	public static final DataParameter<Boolean> FINISHED = EntityDataManager.createKey(EntityCloudFleijaBase.class,DataSerializers.BOOLEAN);
	...
	public EntityCloudFleijaBase(World worldIn) {
		super(worldIn);
		this.setSize(1, 4);
	...
	public EntityCloudFleijaBase setAntischrab() {
		this.isAntischrab = true;
		this.dataManager.set(ANTISCHRAB,true);
		return this;
	}
	public EntityCloudFleijaBase(World p_i1582_1_,int maxAge) {
		super(p_i1582_1_);
		this.setSize(20, 40);
		this.isImmuneToFire = true;
