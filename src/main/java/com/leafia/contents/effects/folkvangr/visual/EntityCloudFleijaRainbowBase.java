...
public class EntityCloudFleijaRainbowBase extends EntityCloudFleijaBase {
	public EntityCloudFleijaRainbowBase(World worldIn) {
		super(worldIn);
	}

	public EntityCloudFleijaRainbowBase(World p_i1582_1_,int maxAge) {
