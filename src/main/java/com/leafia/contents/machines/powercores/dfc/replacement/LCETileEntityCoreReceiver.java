...
public class LCETileEntityCoreReceiver extends DFCBaseTE implements ITickable, IEnergyGenerator, IFluidHandler, ILaserable, ITankPacketAcceptor, SimpleComponent, IControllable {
    ...
    public LCETileEntityCoreReceiver() {
        super(0);
