...
public class AMSEmitterContainer extends Container {

	private AMSEmitterTE amsEmitter;

	private int heat;
	private int warning;

	public AMSEmitterContainer(InventoryPlayer invPlayer,AMSEmitterTE tedf) {
		amsEmitter = tedf;
