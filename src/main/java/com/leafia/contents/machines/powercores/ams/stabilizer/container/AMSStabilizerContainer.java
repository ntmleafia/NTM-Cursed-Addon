...
public class AMSStabilizerContainer extends Container {

	private AMSStabilizerTE amsLmiter;

	private int heat;
	private int warning;
	private int mode;

	public AMSStabilizerContainer(InventoryPlayer invPlayer,AMSStabilizerTE tedf) {
		amsLmiter = tedf;
