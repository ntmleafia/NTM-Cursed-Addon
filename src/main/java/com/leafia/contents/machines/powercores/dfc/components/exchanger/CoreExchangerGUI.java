...
public class CoreExchangerGUI extends LCEGuiInfoContainer {
	final CoreExchangerTE te;
	static final ResourceLocation rsc = new ResourceLocation("leafia","textures/gui/dfc/gui_exchanger.png");
	public CoreExchangerGUI(EntityPlayer player,CoreExchangerTE te) {
		super(new CoreExchangerContainer(player,te));
		xSize = 176;
		ySize = 184;
		this.te = te;
	}
	...
	public void drawScreen(int mouseX,int mouseY,float partialTicks) {
		...
		LeafiaClientUtil.renderTankInfo(te.input,this, mouseX, mouseY, guiLeft + 24, guiTop + 30, 16, 52);
		LeafiaClientUtil.renderTankInfo(te.output,this, mouseX, mouseY, guiLeft + 136, guiTop + 30, 16, 52);
