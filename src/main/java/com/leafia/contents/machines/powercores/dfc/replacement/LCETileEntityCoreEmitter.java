...
public class LCETileEntityCoreEmitter extends DFCBaseTE implements ITickable, IEnergyUser, IFluidHandler, ILaserable, ITankPacketAcceptor, SimpleComponent, IControllable {
	...
	public LCETileEntityCoreEmitter() {
		super(0);
