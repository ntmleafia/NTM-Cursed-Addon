...
public class PWROCCSInTE extends PWRAssignableEntity implements IFluidStandardReceiverMK2, IFluidStandardSenderMK2, ITickable {
	...
	public @NotNull FluidTankNTM[] getReceivingTanks() {
		...
		if (core != null) {
			return new FluidTankNTM[]{core.tanks[5]};
		}
		...
		if (!world.isRemote) {
			...
			if (core != null) {
				for (EnumFacing facing : EnumFacing.values())
					trySubscribe(core.tanks[5].getTankType(),world,pos.offset(facing),ForgeDirection.getOrientation(facing));
			}
		}
	}
