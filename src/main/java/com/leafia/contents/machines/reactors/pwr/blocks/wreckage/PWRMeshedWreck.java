...
public abstract class PWRMeshedWreck extends AddonBlockBase implements ITileEntityProvider {
	...
	public static HFRWavefrontObject meshFromString(String name) {
		if (MainRegistry.proxy instanceof ClientProxy)
			return new HFRWavefrontObject(new ResourceLocation("leafia", "models/leafia/pwrwreck/"+name+".obj"));
		else
			return null;
	}
