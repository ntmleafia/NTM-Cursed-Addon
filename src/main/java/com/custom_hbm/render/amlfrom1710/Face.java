...
public class Face {
    ...
    public Vertex calculateFaceNormal() {
        Vec3 v1 = com.custom_hbm.render.amlfrom1710.Vec3.createVectorHelper(vertices[1].x - vertices[0].x, vertices[1].y - vertices[0].y, vertices[1].z - vertices[0].z);
        Vec3 v2 = com.custom_hbm.render.amlfrom1710.Vec3.createVectorHelper(vertices[2].x - vertices[0].x, vertices[2].y - vertices[0].y, vertices[2].z - vertices[0].z);
